...
const Button = ({ className, children, ...rest }: ButtonProps) => {
    const styles = clsx(
        'relative z-5 w-fit overflow-hidden rounded border-2 border-primary-800 px-10 py-3 font-semibold text-gray-600 dark:text-dark-gray',
        'hover:border-transparent hover:text-white dark:hover:text-white',
