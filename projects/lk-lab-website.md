...
intro: 'A  website built with Jekyll for the Sensory Neuroscience Lab at Oberlin College. It showcases our past and ongoing research, introduces our alumni and current lab members, and provides visitors with a platform to express their interest in joining the lab.'
slug: 'lk-lab-website'
tags:
    - Jekyll
    - CSS
